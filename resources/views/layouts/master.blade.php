    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li @routeactive('categor*')><a href="{{ route('categories') }}">@lang('main.all_categories')</a></li>
                <li @routeactive('basket*')><a href="{{ route('basket') }}">@lang('main.cart')</a></li>
                <li><a href="{{ route('reset') }}">@lang('main.reset_project')</a></li>b
                <li><a href="{{ route('locale', __('main.set_lang')) }}">@lang('main.set_lang')</a></li>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">{{ App\Services\CurrencyConversation::getCurrencySymbol() }}<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        @foreach(App\Services\CurrencyConversation::getCurrencies() as $currency)
